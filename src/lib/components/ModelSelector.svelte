...
<div class="relative" data-model-dropdown>
	<button
		...
		class="flex items-center gap-3 rounded-lg border border-gray-600/30 bg-gray-800/50 px-4 py-2.5 text-sm text-gray-200 shadow-sm backdrop-blur-sm transition-all duration-200 hover:border-gray-500/50 hover:bg-gray-700/60"
	...
	{#if modelDropdownOpen}
		<div
			class="absolute top-full right-0 z-50 mt-2 min-w-[320px] rounded-xl border border-gray-600/30 bg-gray-800/95 shadow-xl backdrop-blur-md"
		>
			<div class="p-4">
