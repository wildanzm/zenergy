...
<nav class="relative z-10 border-b border-gray-700/20 bg-gray-900/80 backdrop-blur-md">
	<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
		<div class="flex h-16 items-center justify-between">
			<!-- Logo/Brand -->
			<div class="flex items-center space-x-3">
				<div
					class="flex h-8 w-8 items-center justify-center rounded-full bg-blue-500 shadow-lg"
				>
				...
				<h1 class="text-lg font-bold text-gray-100">Zenergy</h1>
			</div>
